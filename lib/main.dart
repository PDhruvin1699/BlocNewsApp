...
Future<void> main() async {
  ...
  await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: 'AIzaSyCwUgB6TTAtAAknN2MlHKlSu6B0cumCslw',
        appId: '1:686513775164:android:a307fc4cd66a823cd85939',
        messagingSenderId: '686513775164',
        projectId: 'newsdemo-263d5',
      ));
  await Hive.initFlutter();
  Hive.registerAdapter(ArticleModelAdapter());
