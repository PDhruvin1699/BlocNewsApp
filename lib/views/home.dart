...
//   void initState() {
//     super.initState();
//     // Initialize Firebase Dynamic Links when the app starts
//    // Assuming 'articles' is the list of articles in your app
//   }
//
//
//
...
//                             // Handle 'More' button press
//                           },
//                             textSize: textSize,context: context,
//                         ),
//                       ),
//                     );
//                   }).toList(),
...
class _HomePageState extends State<HomePage> {
  ...
  void handleLinkData(PendingDynamicLinkData? data) {
    ...
    String articleId = deepLink.queryParameters['articleId'] ?? '';
    String title = deepLink.queryParameters['title'] ?? '';
    // Extract other parameters as needed
    String author = deepLink.queryParameters['author'] ?? '';
    String description = deepLink.queryParameters['description'] ?? '';
    String url = deepLink.queryParameters['url'] ?? '';
    String urlToImage = deepLink.queryParameters['urlToImage'] ?? '';
    String publishedAt = deepLink.queryParameters['publishedAt'] ?? '';
    String content = deepLink.queryParameters['content'] ?? '';
String sourceName = deepLink.queryParameters[' sourceName'] ?? '';
      ...
      MaterialPageRoute(
        builder: (context) => DetailsPage(
          article: ArticleModel(
            ...
            content: content, sourceName:sourceName,
            // Set other properties based on the query parameters
          ),
        ),
      ),
    );
